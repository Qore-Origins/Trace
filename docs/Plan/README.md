...
| [离线 PlantUML 本地服务](./Future_Plan/Qore/Trace/Plan-260926-02-离线PlantUML本地服务/Offline-PlantUML-Service-Implementation-Plan.md) | v0.17.0 文档、步骤 1–9 自动与安装包验收完成；Windows 安装包 200.82 MiB，SHA 已记录；远端双平台发布待完成 | 2026-09-26 | [已批准设计规格](../superpowers/specs/2026-09-26-task-state-and-offline-plantuml-design.md) | 合入 main 并 SSH 推送双端，GitHub 上传安装包、Gitee 仅发布说明，核验发布结果 |

发布版本与本地验收（2026-09-26）：用户已确认本批发布为 `v0.17.0`，依据是相对 v0.15.1 新增任务三态反馈与完全离线 PlantUML 两个独立功能域。版本文档与 Windows x64 安装包已更新/核验，大小 200.82 MiB，SHA-256 `394DFFA219B9329B150D19D33DD0887FC67619551AE7E38093DF841E39B41699`；仍待合入 `main`、SSH 推送及 GitHub/Gitee Release 发布核验。
