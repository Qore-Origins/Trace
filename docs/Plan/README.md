...
| [离线 PlantUML 本地服务](./Future_Plan/Qore/Trace/Plan-260926-02-离线PlantUML本地服务/Offline-PlantUML-Service-Implementation-Plan.md) | v0.17.0 本地验收完成并快进合入 main（`f769415`）；远端双平台发布待完成 | 2026-09-26 | [已批准设计规格](../superpowers/specs/2026-09-26-task-state-and-offline-plantuml-design.md) | 主分支门槛复验后创建 tag，SSH 推送双端；GitHub 上传安装包、Gitee 仅发布说明并链接 GitHub |

发布版本与本地验收（2026-09-26）：用户已确认本批发布为 `v0.17.0`，依据是相对 v0.15.1 新增任务三态反馈与完全离线 PlantUML 两个独立功能域。版本文档与 Windows x64 安装包已更新/核验，大小 200.82 MiB，SHA-256 `394DFFA219B9329B150D19D33DD0887FC67619551AE7E38093DF841E39B41699`；本地 `main` 已快进至 `f769415676bc3ebe7676bbc4f6902b8206679a0f`，待远端 SSH 推送及 GitHub/Gitee Release 发布核验。
