...
发布进展（2026-09-26）：`main` 与 `v0.17.0` tag 已通过 SSH 推送至 GitHub/Gitee；两端 `main` 为回填提交 `8122a9e529b5cc05458ffaf29c7e3bf6482c7a90`，tag 指向 `403fcb174667743f2979ba55b9d29b5ef35ce4f4`。GitHub Release 已发布，Windows 安装包 SHA-256 经 GitHub API digest 核对一致。Gitee Release 仍待安全提供 API 凭据，预计只发布说明与 GitHub 下载链接，不附安装包。
