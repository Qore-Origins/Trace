...
const enUS: typeof zhCN = {
  ...
  settings: {
    ...
    plantumlServerDesc: 'Leave empty for offline mode; when configured, diagram source is sent to this HTTP(S) service.',
    plantumlPlaceholder: 'Empty means offline',
    plantumlInvalid: 'PlantUML Server must be a valid HTTP(S) URL',
